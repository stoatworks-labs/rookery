...
**[v0.2.1](https://github.com/stoatworks-labs/rookery/releases/tag/v0.2.1)** — prebuilt for macOS, Windows and Linux. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Apple Silicon · .dmg disk image (CLI) | [`rookery-0.2.1-macos-aarch64-cli.dmg`](https://github.com/stoatworks-labs/rookery/releases/download/v0.2.1/rookery-0.2.1-macos-aarch64-cli.dmg) | 3.7 MB |
| Intel · .dmg disk image (CLI) | [`rookery-0.2.1-macos-x86_64-cli.dmg`](https://github.com/stoatworks-labs/rookery/releases/download/v0.2.1/rookery-0.2.1-macos-x86_64-cli.dmg) | 4.0 MB |
| Apple Silicon · .pkg installer (CLI) | [`rookery-0.2.1-macos-aarch64-cli.pkg`](https://github.com/stoatworks-labs/rookery/releases/download/v0.2.1/rookery-0.2.1-macos-aarch64-cli.pkg) | 3.4 MB |
| Intel · .pkg installer (CLI) | [`rookery-0.2.1-macos-x86_64-cli.pkg`](https://github.com/stoatworks-labs/rookery/releases/download/v0.2.1/rookery-0.2.1-macos-x86_64-cli.pkg) | 3.6 MB |
| Apple Silicon · .tar.gz archive | [`rookery-macos-aarch64.tar.gz`](https://github.com/stoatworks-labs/rookery/releases/latest/download/rookery-macos-aarch64.tar.gz) | 3.4 MB |
| Intel · .tar.gz archive | [`rookery-macos-x86_64.tar.gz`](https://github.com/stoatworks-labs/rookery/releases/latest/download/rookery-macos-x86_64.tar.gz) | 3.5 MB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`rookery-0.2.1-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/rookery/releases/download/v0.2.1/rookery-0.2.1-windows-x86_64-setup.exe) | 2.4 MB |
| ARM64 · .exe installer | [`rookery-0.2.1-windows-aarch64-setup.exe`](https://github.com/stoatworks-labs/rookery/releases/download/v0.2.1/rookery-0.2.1-windows-aarch64-setup.exe) | 2.2 MB |
| x64 · .zip archive | [`rookery-windows-x86_64.zip`](https://github.com/stoatworks-labs/rookery/releases/latest/download/rookery-windows-x86_64.zip) | 3.0 MB |
| ARM64 · .zip archive | [`rookery-windows-aarch64.zip`](https://github.com/stoatworks-labs/rookery/releases/latest/download/rookery-windows-aarch64.zip) | 2.9 MB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .deb package (Debian/Ubuntu) | [`rookery_0.2.1_amd64.deb`](https://github.com/stoatworks-labs/rookery/releases/download/v0.2.1/rookery_0.2.1_amd64.deb) | 3.8 MB |
| ARM64 · .deb package (Debian/Ubuntu) | [`rookery_0.2.1_arm64.deb`](https://github.com/stoatworks-labs/rookery/releases/download/v0.2.1/rookery_0.2.1_arm64.deb) | 3.9 MB |
| x64 · .rpm package (Fedora/RHEL) | [`rookery-0.2.1-1.x86_64.rpm`](https://github.com/stoatworks-labs/rookery/releases/download/v0.2.1/rookery-0.2.1-1.x86_64.rpm) | 4.0 MB |
| ARM64 · .rpm package (Fedora/RHEL) | [`rookery-0.2.1-1.aarch64.rpm`](https://github.com/stoatworks-labs/rookery/releases/download/v0.2.1/rookery-0.2.1-1.aarch64.rpm) | 4.0 MB |
| x64 · .tar.gz archive | [`rookery-linux-x86_64.tar.gz`](https://github.com/stoatworks-labs/rookery/releases/latest/download/rookery-linux-x86_64.tar.gz) | 3.7 MB |
| ARM64 · .tar.gz archive | [`rookery-linux-aarch64.tar.gz`](https://github.com/stoatworks-labs/rookery/releases/latest/download/rookery-linux-aarch64.tar.gz) | 3.8 MB |
